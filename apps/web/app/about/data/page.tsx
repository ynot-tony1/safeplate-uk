  ...
  return (
    <article className="max-w-3xl space-y-1">
      ...
      <p className={pClass}>
        ...
        <a className={linkClass} href="https://www.food.gov.uk/" target="_blank" rel="noreferrer noopener">
        ...
        . We do not collect, verify, or independently inspect any establishment ourselves — everything
        shown here is a re-presentation of the FSA&apos;s published records.
      </p>
      ...
      <p className={pClass}>
        ...
        inspector&apos;s assessment of food hygiene practices, the condition of the premises, and how
        well management systems are run.
      </p>
      <p className={pClass}>
        The <strong className="text-foreground">Food Hygiene Information Scheme (FHIS)</strong> covers
        Scotland, where local authorities instead publish a binary{" "}
      ...
      <p className={pClass}>
        ...
        <strong className="text-foreground">Awaiting Publication</strong> rather than a scored rating
        — this is normal and does not necessarily indicate a problem.
      </p>
      ...
      <p className={pClass}>
        ...
        any new or changed establishment records. We only write a rating-history entry when a rating,
        rating date, score, or pending-rating status actually changes between two imports — not on
        every import — so the history you see reflects real changes over time, not noise from
        re-publishing identical data.
      </p>

      <h2 className={h2Class}>Interpreting a rating date</h2>
      <p className={pClass}>
        A rating date is <strong className="text-foreground">the date of the inspection that
        produced that rating</strong> — it is not a guarantee of current freshness. A business can
        maintain the same rating for years without a new inspection, or standards may have changed
        since the date shown. Always check the{" "}
        <strong className="text-foreground">source extract date</strong> shown on each
        establishment&apos;s page, which tells you how current our copy of the local authority&apos;s
        data is.
      </p>

      <h2 className={h2Class}>Geolocation limitations</h2>
      <p className={pClass}>
        Latitude/longitude coordinates, where present, are supplied by the local authority as part of
        the open data extract. We do not independently verify or geocode these coordinates ourselves —
        some establishments may have imprecise, missing, or occasionally incorrect coordinates as
        published by the source.
      </p>

      <h2 className={h2Class}>Limitations</h2>
      <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-relaxed text-muted-foreground">
        <li>Coverage depends on which local authorities have published usable open data recently.</li>
        ...
        <li>
          ...
          deduplicate near-identical entries, or infer closures beyond what the source data indicates.
        </li>
        <li>
          ...
          <a className={linkClass} href="https://ratings.food.gov.uk/" target="_blank" rel="noreferrer noopener">
